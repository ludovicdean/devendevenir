...
banner : "/src/assets/rubaitul-azad-notion-unsplash.jpg"
readingtime : "11 min"
author : "Hal Gatewood"
...
import homepage from "@assets/notion-homepage.png";
import journal from "@assets/notion-journal-de-dev.png";
import wiki from "@assets/notion-wiki.png";
import search from "@assets/notion-search-result.png";
import command from "@assets/notion-command-menu.png";
import document from "@assets/notion-document-add.png";
import link from "@assets/notion-link-menu.png";
import board from "@assets/notion-board.png";
import recipes from "@assets/notion-recipes.png";
...
<Image src={ homepage } alt="Page d'accueil de votre espace de travail" inferSize class="my-5" />
...
<Image src={ journal } alt="Arborescence de mon journal de développement" inferSize class="my-5" />
...
<Image src={ wiki } alt="Arborescence de mon wiki" inferSize class="my-5" />
...
<Image src={ search } alt="Résultats d'une recherche" inferSize class="my-5" />
...
<Image src={ command } alt="Menu des blocs de base" inferSize class="my-5" />
...
<Image src={ document } alt="Ajout d'un document à une page Notion" inferSize class="my-5" />
...
<Image src={ link } alt="Ajout d'un lien à une page Notion" inferSize class="my-5" />
...
<Image src={ board } alt="Liste de tâches Notion" inferSize class="my-5" />
...
<Image src={ recipes } alt="Un livre de recettes avec Notion" inferSize class="my-5" />
