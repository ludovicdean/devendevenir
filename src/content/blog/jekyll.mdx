...
tags :
    - outils
description : "Jekyll, un générateur de site statique idéal pour créer son blog. Vos débuts avec la génération de sites statiques (SSG)."
banner: "../../assets/banners/glenn-carstens-peters-npxXWgQ33ZQ-unsplash.webp"
