...
On part du tout début, de la définition d'une pipeline, dans laquelle on explicite les termes CI/CD (Intégration continue / déploiement continu). On parle conditionnement d'opérations selon les branches etc.
