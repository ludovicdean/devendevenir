...
Là où le MD-5 était vulnérable aux attaques avec des rainbow tables, l'arrivée des algorithmes tels que Bcrypt, Scrypt et Argon2 ont permis, grâce à leur paramétrabilité, de largement augmenter la difficulté de ce type d'attaque, non pas par l'augmentation du nombre de possibilités mais par l'allongement considérable des temps de calcul.
