...
Mmmmmmmmh, ce n'est pas clair du tout ton affaire !

Dissipons le brouillard qui entoure les regex, au travers d'un cas d'utilisation simple.
...
Dans notre cas, on se rend compte que les 2 mots ont des caractéristiques communes.
...
Les méta-caractères utilisés sont les suivants :
...
| `{m}`          | le nombre exact d'occurrences de l'élément qui le précède                | 1{3}             | 111                                                      |
| `{m, n}`       | l'intervalle d'occurrences recherché (1 à 3 par exemple)                 | 1{3, 4}          | 111, 1111                                                |
| `{m,}`         | l'intervalle d'occurrences recherché à m minimum (2 minimum par exemple) | 1{2,}            | 11, 111, 1111                                            |
