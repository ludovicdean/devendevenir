...
<table>
    <tbody>
    <tr>
        <td>Nombre de bits</td>
        <td>Combinaisons possibles</td>
        <td>Combinaisons</td>
    </tr>
    <tr>
        <td>1</td>
    ...
    <tr>
        <td>3</td>
        <td>8</td>
        <td>111 110 101 100 011 010 001 000</td>
    </tr>
    <tr>
        <td>4</td>
        <td>16</td>
        <td>1111 1110 1101 1100 1011 1010 1001 1000 0111 0110 0101 0100 0011 0010 0001 0000</td>
    </tr>
    </tbody>
</table>
...
<table>
    ...
    <tr>
        <td>nombre d’octets par caractère</td>
        <td>1 - 4</td>
        <td>2 -4</td>
        <td>4</td>
    </tr>
    <tr>
        <td>rétrocompatibilité ASCII</td>
        <td>totale</td>
        <td>partielle</td>
        <td>faible</td>
    </tr>
    <tr>
        <td>mémoire</td>
        <td>économe pour les textes en langues latines, coûteux pour les textes en langues asiatiques</td>
        <td>coûteux pour les  textes en langues latines, efficace pour les textes en langues asiatiques</td>
        <td>dispendieux dans tous les cas</td>
    </tr>
</table>
...
## Mais pourquoi ça dÃ©raille parfois ?
...
Il faut regarder de plus près comment est encodé un e accent aigu en UTF-8 : il est encodé sur 2 octets, plus exactement comme ceci :
