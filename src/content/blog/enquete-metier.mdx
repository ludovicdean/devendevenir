...
Multiplier les personnes consultées ne peut pas faire de mal, et vous donnera des points de vue divers sur le métier que vous envisagez. Cela vour permettra de réduire les "angles morts", ces aspects d'un métier qu'on ne soupçonnait pas avant de le pratiquer.
