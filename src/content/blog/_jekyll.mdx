...
banner : "/src/assets/glenn-carstens-peters-npxXWgQ33ZQ-unsplash.jpg"
readingtime : "5 min"
...
import arborescence from "@assets/jekyll-arborescence.png";
import site from "@assets/jekyll-site-package.png";
import gemfile from "@assets/jekyll-gemfile.png";
...
<Image src={ arborescence } alt="Arborescence d'un projet Jekyll" inferSize class="my-5" />
...
<Image src={ site } alt="Contenu du répertoire _site." inferSize class="my-5" />
...
- Gemfile : le fichier qui référence l'ensemble des gemmes utilisées par le projet
...
<Image src={ gemfile } alt="Arborescence d'un projet Jekyll" inferSize class="my-5" />
