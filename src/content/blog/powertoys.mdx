...
image : "/powertoys.png"
banner : "/hal-gatewood-powertoys-unsplash.jpg"
readingtime : "5 min"
author : Hal Gatewood
...
![Page d'accueil de PowerToys](/devendevenir/powertoys-homepage.png)
&nbsp;
...
<Video path="/devendevenir/powertoys-fancy-zones.webm" />
...
<Video path="/devendevenir/powertoys-awake.webm" />
&nbsp;
...
<Video path="/devendevenir/powertoys-color-picker.webm" />
&nbsp;
...
![Paramétrage des extensions de l'explorateur de fichiers Windows](/devendevenir/powertoys-explorateur-fichiers.png)
...
<Video path="/devendevenir/powertoys-apercu.webm" />
&nbsp;
...
<Video path="/devendevenir/powertoys-keyboard-manager.webm" />
&nbsp;
...
<Video path="/devendevenir/powertoys-power-rename.webm" />
&nbsp;
