...
image : "/src/assets/powertoys.png"
banner : "/src/assets/hal-gatewood-powertoys-unsplash.jpg"
readingtime : "5 min"
author : Hal Gatewood
...
import homepage from "@assets/powertoys-homepage.png";
import explorateur from "@assets/powertoys-explorateur-fichiers.png";
...
<Image src={ homepage } alt="Page d'accueil de PowerToys." inferSize class="my-5" />
...
<Video path="/src/assets/powertoys-fancy-zones.webm" />
...
<Video path="/src/assets/powertoys-awake.webm" />
&nbsp;
...
<Video path="/src/assets/powertoys-color-picker.webm" />
&nbsp;
...
<Image src={ explorateur } alt="Paramétrage des extensions de l'explorateur de fichiers Windows" inferSize class="my-5" />
&nbsp;
...
<Video path="/src/assets/powertoys-apercu.webm" />
&nbsp;
...
<Video path="/src/assets/powertoys-keyboard-manager.webm" />
&nbsp;
...
<Video path="/src/assets/powertoys-power-rename.webm" />
&nbsp;
