...
banner : "/ferenc-almasi-pW3TdRsH8yM-unsplash.jpg"
readingtime : "5 min"
...
![Page de démarrage de Cypress](/devendevenir/cypress-welcome-page.png)

Suivez le guide, Cypress vous indique tout.

<Video path="/devendevenir/cypress-starting.webm" />
...
![Arborescence du projet Cypress](/devendevenir/cypress-arborescence.png)
...
![Page de test de Cypress](/devendevenir/cypress-test-page.png)
