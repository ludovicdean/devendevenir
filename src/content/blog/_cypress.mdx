...
banner : "/src/assets/ferenc-almasi-pW3TdRsH8yM-unsplash.jpg"
readingtime : "5 min"
...
import homepage from "@assets/cypress-welcome-page.png";
import arborescence from "@assets/cypress-arborescence.png";
import test from "@assets/cypress-test-page.png";
...
Si ce n'est pas déjà le cas sur votre machine, vous devrez installer NodeJS. Vous trouvrez le nécessaire [ici](https://nodejs.org/en/download/current).
...
<Image src={ homepage } alt="Page de démarrage de Cypress" inferSize class="my-5" />

Suivez le guide, Cypress vous indique tout.

<Video path="/src/assets/cypress-starting.webm" />
...
<Image src={ arborescence } alt="Arborescence du projet Cypress." inferSize class="my-5" />
...
<Image src={ test } alt="Page de test de Cypress" inferSize class="my-5" />
...
- le texte d'un attribut de balise (a[href*="texte"])
